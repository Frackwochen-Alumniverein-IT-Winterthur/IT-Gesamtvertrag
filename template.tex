...
\begin{contract}
  ...
  \noindent\begin{tabular}{ll}
    ...
    Bartvogt 1 - \textcolor{blue}{<KLASSE>} & Bartvogt 2 - \textcolor{blue}{<KLASSE>} \\[8ex]
    \makebox[6.5cm]{\hrulefill}             & \makebox[6.5cm]{\hrulefill}             \\
    Bartvogt 3 - \textcolor{blue}{<KLASSE>} & Bartvogt 4 - \textcolor{blue}{<KLASSE>} \\[8ex]
    \makebox[6.5cm]{\hrulefill}             & \makebox[6.5cm]{\hrulefill}             \\
    Bartvogt 5 - \textcolor{blue}{<KLASSE>} & Bartvogt 6 - \textcolor{blue}{<KLASSE>} \\[8ex]
    \makebox[6.5cm]{\hrulefill}             & \makebox[6.5cm]{\hrulefill}             \\
    Bartvogt 7 - \textcolor{blue}{<KLASSE>} & Bartvogt 8 - \textcolor{blue}{<KLASSE>} \\
  \end{tabular}
  \parnumbertrue
