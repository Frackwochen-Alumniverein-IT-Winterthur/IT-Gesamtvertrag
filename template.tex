...
\usepackage[margin=2cm,footskip=45pt]{geometry}
...
\begin{contract}
  ...
  Missachtet ein:e Vor-Würdiger:in die Erkennungsaufgabe \refS{H.erkennungsaufgabe} oder ist unfähig auf Anfrage die Wissensaufgabe \refS{H.wissensaufgabe} zu erfüllen,
  so muss er / sie eine der im "<C-Handbuch unserer Geschichte"> definierten Excercises lösen und einem Bartvogt vorführen.
