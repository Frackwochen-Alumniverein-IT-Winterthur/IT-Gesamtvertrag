...
\begin{contract}
  ...
  Abdruck von jeden zukünftigen Würdigen enthalten. % verstehe den Satz nicht
  ...
  zu ermöglichen, siehe \refS{H.nachzug}. % verstehe den Satz nicht
  ...
  und die Erkennungshülle von seinem Bartvogt. Die Seiten stammen aus der Verteungssicherheitsmarge \refS{H.verteilungsmarge}. % was ist das?
  ...
  bleibt das "<C-Handbuch unserer Geschichte"> weiter bestehen aber Unwürdige nicht.
...
\begin{contract}
  ...
  sobald der Campus der ZHAW betreten wird. Dabei kann der Hut vom / von der Vor-Würdigen selbst beschafft werden, solange das Model von den Bartvögten
  ...
  Die versammelte Klasse muss intern mit dem FAI koordinieren, um Zugang zum "<C-Handbuch unserer Geschichte"> zu erhalten und die Unterschrift
  ...
  Wird festgestellt, dass ein Teilnehmender dieser Verpflichtung nicht nachkommt, so ist dieser verpflichtet, unverzüglich ein alkoholisches Getränk in der Menge von 0,33 Litern (Bier) in einem Zuge („Ex-Trinken“) zu konsumieren und den Nachweis hierüber in Form eines Videoaufzeichnungsbeweises an die übrigen Teilnehmenden zu übermitteln.
  ...
  \SubClause[title={Titel}]
  Die Vor-Würdigen der Klasse IT22a WIN, die die Ersatzverantwortung nach \refS{KlasseIT22aZH.ersatz} erfüllen, verdienen den Titel "<Titel">.
